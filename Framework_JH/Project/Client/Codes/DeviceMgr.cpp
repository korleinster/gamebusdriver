...
HRESULT CDeviceMgr::Init(WinMode _eWinMode)
{
	UINT	deviceFlags = 0;
	...
	tSwapChain.BufferDesc.Width = (UINT)WINCX;
	tSwapChain.BufferDesc.Height = (UINT)WINCY;
	...
	FAILED_CHECK(m_pSwapChain->ResizeBuffers(
		1, (UINT)WINCX, (UINT)WINCY, DXGI_FORMAT_R8G8B8A8_UNORM, 0));
	...
	tDepthStencil.Width = (UINT)WINCX;
	tDepthStencil.Height = (UINT)WINCY;
