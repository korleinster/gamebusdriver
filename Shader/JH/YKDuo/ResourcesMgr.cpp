...
HRESULT CResourcesMgr::AddBuffer(LPDIRECT3DDEVICE9 pDevice, const WORD & wContainerIndex, BUFFERTYPE eBufferType, const wstring wstrResourceKey, const WORD & wCountX, const WORD & wCountZ, const WORD & wInterval)
{
	...
	case BUFFER_CYLINDER :
		pBuffer = CCylinderCol::Create(1.f,1.f,1.f,10,10);
