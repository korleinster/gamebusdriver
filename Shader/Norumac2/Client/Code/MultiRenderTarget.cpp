...
HRESULT CMultiRenderTarget::Initialize(UINT width, UINT height)
{
	...
	m_ColorSpecIntensityRTV->SetPrivateData(WKPDID_D3DDebugObjectName, lstrlenA("GBuffer - Color Spec Intensity RTV"), "GBuffer - Color Spec Intensity RTV");
...
void CMultiRenderTarget::Begin_MRT(ID3D11DeviceContext* pd3dImmediateContext)
{
	...
	pd3dImmediateContext->ClearDepthStencilView(
		m_DepthStencilDSV, // Áö¿ì°íÀÚ ÇÏ´Â ºÎºÐ
		D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL, // ±íÀÌ¹öÆÛ, ½ºÅÙ½Ç¹öÆÛ Áö¿ì±â 
